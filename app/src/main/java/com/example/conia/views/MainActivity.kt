...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    private fun loadPriorityCache() {
        CareerCacheConstants.setCache(mCareerBusiness.getList())
    }
...
//    }
    ...
    private fun formatDate() {
        ...
        tvDate.text = "${dayOfWeek}, ${dayOfMonth}  ${month}  ${year}"

    }

    private fun formatName(format: String, type: Int, n: Int): String{
        val simpleDateMonth = SimpleDateFormat(format, Locale("esp", "sv"))
