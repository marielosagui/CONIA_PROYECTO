...
class TaskRepository private constructor(context: Context) {
        ...
        try {
            ...
            if (cursor.count > 0) {
                ...
                while (cursor.moveToNext()) {
                    ...
                    val priorityId = cursor.getInt(cursor.getColumnIndex(DatabaseConstants.TASK.COLUMNS.CAREERID))
    ...
    fun get(id: Int): TaskEntity? {
        ...
        try {
            ...
            val projection = arrayOf(DatabaseConstants.TASK.COLUMNS.ID,
                    ...
                    DatabaseConstants.TASK.COLUMNS.CAREERID,
    ...
    fun insert(task: TaskEntity) {
        try{
            ...
            insertValues.put(DatabaseConstants.TASK.COLUMNS.CAREERID, task.careerId)
    ...
    fun update(task: TaskEntity) {
        try{
            ...
            updateValues.put(DatabaseConstants.TASK.COLUMNS.CAREERID, task.careerId)
